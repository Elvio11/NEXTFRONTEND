"""
llm/sarvam.py
Sarvam-M cloud API client for Server 2.
...
Modes map to Sarvam's reasoning_effort parameter:
  think     → reasoning_effort="high"   — Agents 3, 4, 5, 6 full_scan, 8
  no_think  → reasoning_effort="low"    — Agent 6 delta (fast batch)
  precise   → reasoning_effort="medium" — Agent 14 follow-up emails (Server 3)
"""
