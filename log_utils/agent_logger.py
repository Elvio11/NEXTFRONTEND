...
def log_event(component: str, level: str, message: str) -> None:
    """
    Lightweight structured log for non-agent components (e.g. whatsapp_push, skills).
    Writes to Python logging only — no DB write.
    Never raises.
    """
    try:
